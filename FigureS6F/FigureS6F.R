...
ASV_Silk_ITS_2w<-ASV_Silk_ITS[1:3,]
ASV_Silk_ITS_4w<-ASV_Silk_ITS[4:6,]
ASV_Silk_ITS_6w<-ASV_Silk_ITS[7:9,]
ASV_Silk_ITS_8w<-ASV_Silk_ITS[10:12,]

ASV_Soil_ITS_2w<-ASV_Soil_ITS[1:3,]
ASV_Soil_ITS_4w<-ASV_Soil_ITS[4:6,]
ASV_Soil_ITS_6w<-ASV_Soil_ITS[7:9,]
ASV_Soil_ITS_8w<-ASV_Soil_ITS[10:12,]
...
paired_beta_nti_silk_2w <- beta_nti(otu_niche = ASV_Silk_ITS_2w, otu_tree = tree_ITS,1000,8)

write.table(paired_beta_nti_silk_2w,"paired_beta_nti_silk_2w.txt",quote = FALSE,
            sep = "\t",row.names = TRUE,col.names = TRUE)


paired_beta_nti_silk_4w <- beta_nti(otu_niche = ASV_Silk_ITS_4w, otu_tree = tree_ITS,1000,8)

write.table(paired_beta_nti_silk_4w,"paired_beta_nti_silk_4w.txt",quote = FALSE,
            sep = "\t",row.names = TRUE,col.names = TRUE)


paired_beta_nti_silk_6w <- beta_nti(otu_niche = ASV_Silk_ITS_6w, otu_tree = tree_ITS,1000,8)

write.table(paired_beta_nti_silk_6w,"paired_beta_nti_silk_6w.txt",quote = FALSE,
            sep = "\t",row.names = TRUE,col.names = TRUE)


paired_beta_nti_silk_8w <- beta_nti(otu_niche = ASV_Silk_ITS_8w, otu_tree = tree_ITS,1000,8)
...
paired_beta_nti_soil_2w <- beta_nti(otu_niche = ASV_Soil_ITS_2w, otu_tree = tree_ITS,1000,8)

write.table(paired_beta_nti_soil_2w,"paired_beta_nti_soil_2w.txt",quote = FALSE,
            sep = "\t",row.names = TRUE,col.names = TRUE)


paired_beta_nti_soil_4w <- beta_nti(otu_niche = ASV_Soil_ITS_4w, otu_tree = tree_ITS,1000,8)
...
paired_beta_nti_soil_6w <- beta_nti(otu_niche = ASV_Soil_ITS_6w, otu_tree = tree_ITS,1000,8)
...
paired_beta_nti_soil_8w <- beta_nti(otu_niche = ASV_Soil_ITS_8w, otu_tree = tree_ITS,1000,8)
