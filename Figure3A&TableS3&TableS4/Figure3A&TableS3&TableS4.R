...
raw_data <- read.table("16S_profiling.Phylum.top10.txt",header = TRUE,row.names = 1,sep = "\t")
...
#output Table S3
write_csv(diff,file="16S_diff_bonferroni.csv")
...
## save image
ggsave("Abundance_diff.pdf",p,width = 10,height = 4)
...
#ITS
raw_data <- read.table("ITS_profiling.Phylum.top10.txt",header = TRUE,row.names = 1,sep = "\t")
group <- read.table("group.txt",header = FALSE,sep = "\t")
...
#output Table S4
write_csv(diff,file="ITS_diff_bonferroni.csv")
